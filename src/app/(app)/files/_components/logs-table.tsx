...
export function FilesTable({ groups, currentPage, totalPages, totalCount }: FilesTableProps) {
              ...
              <tr key={group.id} className="border-b hover:bg-muted/50 transition-colors">
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2">
                    <Link href={`/files/${group.id}`} className="font-medium hover:underline">
                      {group.title}
                    </Link>
                    {!group.can_edit && (
                ...
                <td className="px-4 py-3">
                  <Button asChild variant="ghost" size="sm">
                    <Link href={`/files/${group.id}`}>View</Link>
                  </Button>
                </td>
              </tr>
            ))}
